...
| **discord-content-post** | Posts creator education into a brand's Discord community — either a product brief or a breakdown of one real top-performing video — and schedules it to recur. Picks the video, writes the post, asks which channel, screens hooks for brand safety, and posts or schedules via the Discord API. |
